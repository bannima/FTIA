...
# -*- coding:utf-8 -*-
"""
FileName: SST2_Loader.py
Description: 
Author: Barry Chow
Date: 2019/2/6 7:02 PM
Version: 0.1
"""
#import sys
#reload(sys)
...
class SST2DataLoader(Dataset):
    def __init__(self,is_train_set=True,occupy=0.7):
        ...
        self.train_dataset,self.train_labels = self.load_dataset(filepath+'stsa.binary.train.txt')
        self.test_dataset,self.test_labels = self.load_dataset(filepath+'stsa.binary.test.txt')
